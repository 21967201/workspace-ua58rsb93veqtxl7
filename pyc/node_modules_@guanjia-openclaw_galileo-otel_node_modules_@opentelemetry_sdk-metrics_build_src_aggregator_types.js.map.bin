...
declare const ipcHelper: IpcHelper;
...
export { type ElectronApp, type IpcHelper, type Is, type Optimizer, type Platform, electronApp, ipcHelper, is, optimizer, platform, type shortcutOptions };
